...
import com.example.myf00dl00ks.RecipeRecyclerViewAdapter;
import com.example.myf00dl00ks.recipes;
...
public class ExplorerFragment extends Fragment {
    ...
    RecipeRecyclerViewAdapter myAdpter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myrecyclerView = (RecyclerView)view.findViewById(R.id.my_recyclerView2_id);

        myAdapter = new RecipeRecyclerViewAdapter(getContext(),recipes1);
